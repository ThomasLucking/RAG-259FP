...
Maintenant que le backend est terminé, le code n'est cependant pas encore modulaire. J'ai dû transformer chaque fichier en différentes fonctions et permettre le passage de paramètres. J'ai décidé de demander à Claude de le faire puisque je veux gagner du temps.
